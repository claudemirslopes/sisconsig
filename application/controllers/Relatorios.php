            ...
            if ($contas == 'vencidas') {
                ...
                if ($this->financeiro_model->get_contas_receber_relatorio($conta_receber_status, $data_vencimento)) {
                    ...
                    foreach ($contas as $conta):              
						...
						if($conta->pessoa == 1) {
                        	$html .= '<td align="left" style="border: solid #ddd 1px;padding: 3px">'.$conta->nome.' '.$conta->sobrenome.'</td>';
						} else {
							$html .= '<td align="left" style="border: solid #ddd 1px;padding: 3px">'.$conta->sobrenome.'</td>';
						}
        ...
        if ($contas == 'pagas' || $contas == 'vencidas' || $contas == 'a_pagar') {
            ...
            if ($contas == 'vencidas') {
                ...
                if ($this->financeiro_model->get_contas_pagar_relatorio($conta_pagar_status, $data_vencimento)) {
                    ...
                    $html .= '<th align="center" style="border: solid #ddd 1px;background: #ccc;padding: 3px">Data Venc.</th>';
                    $html .= '<th align="left" style="border: solid #ddd 1px;background: #ccc;padding: 3px">Parceiro</th>';
                    $html .= '<th align="center" style="border: solid #ddd 1px;background: #ccc;padding: 3px">CPF/CNPJ</th>';
                    $html .= '<th align="center" style="border: solid #ddd 1px;background: #ccc;padding: 3px">Situação</th>';
                    $html .= '<th align="center" style="border: solid #ddd 1px;background: #ccc;padding: 3px">Valor Total</th>';
                    $html .= '</tr>'; 
                    ...
                    foreach ($contas as $conta):              
                        ...
                        if($conta->parceiro_pessoa == 1) {
                        	$html .= '<td align="left" style="border: solid #ddd 1px;padding: 3px">'.$conta->parceiro_nome.' '.$conta->parceiro_sobrenome.'</td>';
						} else {
							$html .= '<td align="left" style="border: solid #ddd 1px;padding: 3px">'.$conta->parceiro_sobrenome.'</td>';
						}
                        $html .= '<td align="center" style="border: solid #ddd 1px;padding: 3px">'.$conta->parceiro_cpf_cnpj.'</td>';
                        $html .= '<td align="center" style="border: solid #ddd 1px;padding: 3px">vencida</td>';
