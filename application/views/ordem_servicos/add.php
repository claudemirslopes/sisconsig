        ...
        <div class="content mt-1">
            <div class="card">
                <div class="card-header bg-secondary text-light">
                    <strong class="card-title" v-if="headerText">Cadastrar Ordem de Serviço</strong>
                        ...
                        <fieldset id="vendas" class="border p-2" style="margin-top: -10px;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="ui-widget col-lg-2 mb-1 mt-1">
                                    <input class="form-control bg-dark text-light text-center" name="ordem_servico_pedido" value="<?php echo $ordem_servico_pedido; ?>" readonly="">
