...
<!--                            <li><a href="#">Cadastros</a></li>
        ...
        <div class="content mt-2">
            <div class="card" style="border: 1px solid #A4A4A4;">
<!--                <div class="card-header">
                    <strong class="card-title" v-if="headerText"><big><span class="badge badge-dark">Orçamento | CONCLUSÃO</span></big></strong>
                    ...
                    <div class="col-lg-12">
                        <div class="card bdent">
                            ...
                            <div class="card-body card-block">
                                <div class="alert alert-dark" role="alert">
                                    <span class="badge badge-pill badge-danger">Atenção</span> Os dados de geração desta proposta são apenas uma referência baseado em dados teóricos. É responsabilidade do Integrador/ Franqueado a visita técnica ao cliente e conferir as condições de instalação, como inclinação, sombreamento, posição, etc para garantir a geração de energia correta!
                                </div>
                                <div class="has-success form-group">
                                    <label for="inputIsValid" class=" form-control-label">Energia Média Gerada por Painel Mensalmente em STC <small>(Standard Test Conditions - em KWh/mês)</small></label>
                                    <input type="text" id="inputIsValid" class="is-valid form-control-success form-control" readonly="">
                                </div>
                                <div class="has-success form-group">
                                    <label for="inputIsValid" class=" form-control-label">Energia Total Gerada Mensalmente em função do consumo Ponta e Fora de Ponta <small>(KWh/mês)</small></label>
                                    <input type="text" id="inputIsValid" class="is-valid form-control-success form-control" readonly="">
                                </div>
                                <div class="has-warning form-group">
                                    <label for="inputIsInvalid" class=" form-control-label">Número Total de Painéis Fotovoltaicos para <strong class="text-secondary">ZERAR Consumo Ponta</strong> e <strong class="text-secondary">Fora de Ponta</strong></label>
                                    <input type="text" id="inputIsValid" class="is-valid form-control-success form-control" readonly="">
                                </div>
                                <div class="has-success form-group">
                                    <label for="inputIsValid" class=" form-control-label">Quantidade de Painéis em função da <strong class="text-secondary">Demanda Contratada</strong></label>
                                    <input type="text" id="inputIsValid" class="is-valid form-control-success form-control" readonly="">
                                </div>
                                <div class="has-warning form-group">
                                    <label for="inputIsInvalid" class=" form-control-label">Quantidade de Painéis em função do <strong class="text-secondary">Consumo Fora de Ponta</strong></label>
                                    <input type="text" id="inputIsValid" class="is-valid form-control-success form-control" readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card bdent">
                            <div class="card-header bg-secondary text-light">
                                <strong>Margens de Lucro e Mão de Obra</strong>
                            </div>
                            <div class="card-body card-block">
                                <div class="has-success form-group  col-md-5">
                                    <label for="inputIsValid" class=" form-control-label">Margem sobre o Kit <big>(%)</big></label>
                                                ...
                                                <div class="divbaixo">
                                                    <div class="col externa">
                                                        <ul style="list-style-type: none;text-align: center;color: #03668A;">
                                                            <li>Seguro para Orçamento 1: R$ 201,19</li>
                                                            <li>Seguro para Orçamento 2: R$ 9.847,11</li>
                                                            <li>Seguro para Orçamento 3: R$ 96,74</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="container" style="margin-top: 25px;margin-bottom: 25px;">
                                    <div class="row">
                                        <div class="col externa">
                                            <div class="divbaixo">
                                                <div class="col externa">
                                                    <span style="font-size: 1.1em;font-weight: bold;margin-bottom: 10px;color: #036696;">Incluir Seguro de Instalação nesta Proposta | <small><b>Valor do seguro:</b> Grátis</small></span>
                                                    <input type="radio" name="orc_id_painel" class="form-control form-check">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col externa">
                                            <div class="divbaixo">
                                                <div class="col externa">
                                                    <span style="font-size: 1.1em;font-weight: bold;margin-bottom: 10px;color: #036696;"><span class="text-danger font-weight-bold">Não</span> incluir Seguro de Instalação nesta Proposta</span>
                                                    <input type="radio" name="orc_id_painel" class="form-control form-check">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card bdent">
                            <div class="card-header bg-secondary text-light">
                                <strong>Soma dos Orçamentos</strong>
                            </div>
                            <div class="card-body card-block">
                                <div class="container">
                                    <div class="row">
                                        <div class="col externa">
                                            <div class="alert text-left" style="background: #FACC2E;color: #03668A;" role="alert">
                                                <label class=" form-control-label" style="font-size: 1.2em;">Preço de Tabela do Kit BlueSun para <b>Integradores</b></label>
                                                <div class="input-group mb-2 bg-light" style="border: 1px solid #fff;border-radius: 5px;">
                                                    <div class="input-group-addon"><span class="font-weight-bold" style="font-size: 1.1em;">R$</span></div>
                                                    <input class="form-control border-0 text-dark font-weight-bold" style="font-size: 1.3em;" value="145.254,25" readonly="">
                                                </div>
                                                ...
                                                <div class="input-group bg-light" style="border: 1px solid #fff;border-radius: 5px;">
                                                    <div class="input-group-addon"><span class="font-weight-bold" style="font-size: 1.1em;">R$</span></div>
                                                    <input class="form-control border-0 text-dark font-weight-bold" style="font-size: 1.3em;" value="165.524,98" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col externa">
                                            <div class="alert text-light font-weight-bold text-left" style="background: #B40404;" role="alert">
                                                <label class=" form-control-label" style="font-size: 1.5em;">Valor do KIT para <span class="text-warning">Franqueado</span> Bluesun</label>
                                                <div class="input-group mb-2 bg-light" style="border: 1px solid #fff;border-radius: 5px;">
                                                    <div class="input-group-addon"><span class="font-weight-bold text-danger" style="font-size: 1.1em;">R$</span></div>
                                                    <input class="form-control border-0 text-danger font-weight-bold" style="font-size: 1.5em;" value="122.485,96" readonly="">
                                                </div>
                                                <label class=" form-control-label">Valor Franqueado Final</label>
                                                <div class="input-group bg-light" style="border: 1px solid #fff;border-radius: 5px;">
                                                    <div class="input-group-addon"><span class="font-weight-bold text-danger" style="font-size: 1.1em;">R$</span></div>
                                                    <input class="form-control border-0 text-danger font-weight-bold" style="font-size: 1.5em;" value="127.587.33" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
