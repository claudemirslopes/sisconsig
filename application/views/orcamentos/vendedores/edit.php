<?php
    if ($vendedor->vend_fran_cliente_id != $this->session->userdata('userlogado')->cliente_id) {
        $this->session->set_flashdata('error', 'Este vendedor não pode ser acessado!');
        ...
        <div class="content mt-1">
            <div class="card">
                <div class="card-header bg-secondary text-light">
                    <strong class="card-title" v-if="headerText">Editar Vendedor</strong>
                    <span class="float-right" style="color: #777;font-size: .9em;">
                        <strong><i class="fa fa-clock-o"></i>&nbsp;&nbsp;Última alteração: </strong><?php echo formata_data_banco_com_hora($vendedor->vend_fran_data_alteracao); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <form method="post" name="form_edit" class="user" id="post">
                        ...
                        <fieldset class="border p-2" style="margin-top: -10px;">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="vend_fran_pessoa">Vendedor Tipo <span style="color: red;font-weight: bold;">*</span></label>
                                    <select name="vend_fran_pessoa" class="form-control custom-select" id="vend_fran_pessoa" readonly="">
                                        <option readonly="" value="<?php echo ($vendedor->vend_fran_pessoa == 1 ? '1' : '2'); ?>"><?php echo ($vendedor->vend_fran_pessoa == 1 ? 'Pessoa Física' : 'Pessoa Jurídica'); ?></option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                <?php if ($vendedor->vend_fran_pessoa == 1):  ?>
                                     <label for="vend_fran_cpf">CPF <span style="color: red;font-weight: bold;">*</span></label>
                                     <input type="text" name="vend_fran_cpf" class="form-control form-control-user cpfmask" id="cpf" placeholder="CPF" value="<?php echo $vendedor->vend_fran_cpf_cnpj ?>">
                                ...
                                <?php else: ?>
                                     ...
                                     <input type="text" name="vend_fran_cnpj" class="form-control form-control-user cnpjmask" id="cnpj" placeholder="CNPJ" value="<?php echo $vendedor->vend_fran_cpf_cnpj ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="vend_fran_status" class="form-control custom-select" id="vend_fran_status">
                                        <option value="0" <?php echo ($vendedor->vend_fran_status == 0) ? 'selected' : ''; ?>>Não</option>
                                        <option value="1" <?php echo ($vendedor->vend_fran_status == 1) ? 'selected' : ''; ?>>Sim</option>
                                    </select>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="mt-2 border p-2">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <?php if ($vendedor->vend_fran_pessoa == 1):  ?>
                                    <label for="vend_fran_nome">Nome <span style="color: red;font-weight: bold;">*</span></label>
                                <?php else: ?>
                                    <label for="vend_fran_nome">Razão Social <span style="color: red;font-weight: bold;">*</span></label>
                                <?php endif; ?>
                                    <input type="text" name="vend_fran_nome" class="form-control form-control-user" id="nome" placeholder="<?php echo ($vendedor->vend_fran_pessoa == 1 ? 'Nome' : 'Razão Social') ?>" value="<?php echo $vendedor->vend_fran_nome; ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="email" name="vend_fran_email" class="form-control form-control-user" id="email" placeholder="E-mail" value="<?php echo $vendedor->vend_fran_email; ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="vend_fran_tel_cel" class="form-control form-control-user celular" id="telefone" placeholder="Telefone/Celular" value="<?php echo $vendedor->vend_fran_tel_cel; ?>">
                        ...
                        <fieldset class="mt-2 border p-2">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="vend_fran_cep" class="form-control form-control-user cep" id="cep" placeholder="CEP" value="<?php echo $vendedor->vend_fran_cep; ?>">
                                ...
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" name="vend_fran_endereco" class="form-control form-control-user" id="logradouro" placeholder="Logradouro, rua, etc..." value="<?php echo $vendedor->vend_fran_endereco; ?>">
                                    <?php echo form_error('vend_fran_endereco', '<small class="form-text text-danger">','</small>') ?>
                                </div>
                                <div class="form-group col-md-1">
                                    <label for="vend_fran_numero">Nº</label>
                                    <input type="text" name="vend_fran_numero" class="form-control form-control-user" id="numero" placeholder="nº" value="<?php echo $vendedor->vend_fran_numero; ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" name="vend_fran_complemento" class="form-control form-control-user" id="complemento" placeholder="Complemento" value="<?php echo $vendedor->vend_fran_complemento; ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="vend_fran_bairro" class="form-control form-control-user" id="bairro" placeholder="Bairro" value="<?php echo $vendedor->vend_fran_bairro; ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="vend_fran_cidade" class="form-control form-control-user" id="cidade" placeholder="Cidade" value="<?php echo $vendedor->vend_fran_cidade; ?>">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <select name="vend_fran_estado" class="form-control custom-select" id="uf">
                                        <option value="<?php echo $vendedor->vend_fran_estado ?>"><?php echo $vendedor->vend_fran_estado ?></option>
                        ...
                        <input type="hidden" name="vend_fran_id" value="<?php echo $vendedor->vend_fran_id; ?>">
                        <input type="hidden" name="vend_fran_cliente_id" value="<?php echo $vendedor->vend_fran_cliente_id; ?>">
                        
                        <button type="submit" class="btn btn-primary btn-sm float-right mt-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar vendedor</button>
                    </form>
                </div>
