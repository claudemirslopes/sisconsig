								...
								<div class="card">
									<div class="card-header">
										...
										<div class="pull-right">
											<a href="<?php echo base_url('/'); ?>clientes/add"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;&nbsp; Novo Cliente</button></a>
