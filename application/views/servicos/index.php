                   ...
                   <table class="bootstrap-data-table-export table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo base_url('servicos/edit/'.$servico->servico_id); ?>" class="btn btn-sm btn-primary" title="Editar"><i class="fa fa-pencil"></i></a>
                                    <a href="javascript(void)" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#servico-<?php echo $servico->servico_id; ?>" title="Excluír"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticModalLabel">Excluír servico</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                Deseja mesmo excluír este servico?
                                            </p>
                                        </div>
