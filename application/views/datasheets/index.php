                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="<?php echo base_url('home'); ?>" style="color: #47AA0B;">Home</a></li>
        ...
        <div class="content mt-1">
            <div class="card">
                <div class="card-header bg-secondary text-light">
                    ...
                    <a title="Cadastrar novo datasheet" href="<?php echo base_url('datasheets/add'); ?>" class="btn btn-light btn-sm float-right"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Novo Datasheet</a>
                </div>
