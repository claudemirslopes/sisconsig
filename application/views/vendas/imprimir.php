                ...
                <!-- Mensagem de erro -->
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body text-white timd1"  style="border: 1px solid #B5B5B5;">
                                <a href="<?php echo base_url('vendas/pdf/'.$venda->venda_id); ?>" target="_blank" class="btn btn-danger btn-icon-split btn-lg btn-block">
                                    <span class="icon text-white-50" style="float: left;">
                                        <i class="fa fa-print"></i>
                                    </span>
                                    <span class="text">&nbsp;Imprimir Venda <span style="font-size: .6em;"><i class="fa fa-file-pdf-o"></i></span></span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body text-white timd2"  style="border: 1px solid #B5B5B5;">
                                <a href="<?php echo base_url('vendas/add'); ?>" class="btn btn-success btn-icon-split btn-lg btn-block">
                                    <span class="icon text-white-50" style="float: left;">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body text-white timd3"  style="border: 1px solid #B5B5B5;">
                                <a href="<?php echo base_url('vendas'); ?>" class="btn btn-info btn-icon-split btn-lg btn-block">
                                    <span class="icon text-white-50" style="float: left;">
