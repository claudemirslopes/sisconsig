        ...
        <div class="content mt-1">
            <div class="card">
                <div class="card-header bg-secondary text-light">
                    ...
                    <a title="Cadastrar novo aviso" href="<?php echo base_url('avisos/add'); ?>" class="btn btn-light btn-sm float-right"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Novo aviso</a>
                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticModalLabel">Excluír avisado</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                Deseja mesmo excluír esta avisado?
                                            </p>
                                        </div>
