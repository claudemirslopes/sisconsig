        ...
        <div class="content mt-1">
            <div class="card">
                <div class="card-header bg-secondary text-light">
                    <strong class="card-title" v-if="headerText">Cadastrar Marca</strong>
                    <span class="float-right" style="color: #777;font-size: .9em;">
                        <a title="Voltar" href="<?php echo base_url('marcas'); ?>" class="btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Voltar</a>
                    </span>
                </div>
                ...
                <!-- Mensagem de erro -->
                    ...
                    <form method="post" name="form_edit" class="user">
                        ...
                        <fieldset class="border p-2" style="margin-top: -10px;">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-10">
                                    ...
                                    <input type="text" name="marca_nome" class="form-control form-control-user" id="marca_nome" placeholder="Nome do Marca" value="<?php echo set_value('marca_nome'); ?>">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm float-right mt-1"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Adicionar marca</button>
                    </form>
                </div>
