								...
								<div class="card">
									<div class="card-header">
										...
										<div class="pull-right">
											<a href="<?php echo base_url('/'); ?>marcas/add"><button type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Nova marca</button></a>
										...
										<table id="example0" class="table table-striped table-bordered table-sm">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right">
														<a href="<?php echo base_url('marcas/edit/'.$marca->marca_id); ?>" class="btn btn-sm btn-info" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript(void)" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#marca-<?php echo $marca->marca_id; ?>" title="Excluír"><i class="fa fa-trash" aria-hidden="true"></i></a>
													</td>
												</tr>
												<?php endforeach; ?>
											</tbody>
