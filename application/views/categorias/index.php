									...
									<table id="example0" class="table table-striped table-bordered table-sm">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right">
														<a href="<?php echo base_url('categorias/edit/'.$categoria->categoria_id); ?>" class="btn btn-sm btn-info" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript(void)" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#categoria-<?php echo $categoria->categoria_id; ?>" title="Excluír"><i class="fa fa-trash" aria-hidden="true"></i></a>
													</td>
												</tr>
												<?php endforeach; ?>
											</tbody>
