								...
								<div class="card">
									...
									<!-- Mensagem de erro -->
										...
										<form method="post" name="form_edit" class="user" id="post">
												...
												<div class="form-row">
													...
													<div class="form-group col-md-3">
														...
														<select name="parceiro_tipo" class="form-control custom-select" id="parceiro_tipo">
															<option value="1" <?php echo ($parceiro->parceiro_tipo == 1) ? 'selected' : ''; ?>>Consignado</option>
															<option value="2" <?php echo ($parceiro->parceiro_tipo == 2) ? 'selected' : ''; ?>>Fornecedor</option>
														</select>
													</div>
											...
											<fieldset class="mt-2 border p-2">
												...
												<div class="form-row">
													...
													<div class="form-group col-md-4">
														...
														<small class="form-text text-info font-weight-bold">Deixe em branco caso não queira trocar a senha</small>
											...
											<button type="submit" class="btn btn-primary btn-sm float-right mt-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar parceiro</button>
										</form>
									</div>
