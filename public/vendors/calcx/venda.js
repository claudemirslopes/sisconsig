        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Produto não encontrado') {
                ...
                var markup = '<tr>\
                    ...
                    <td class="text-center"><input type="hidden" name="valor_desconto_produto[]" data-cell="H' + i + '"  data-format="R$ 0,0.00" data-formula="((C' + i + '*D' + i + ')-F' + i + ')"><button title="Remover o produto" class="btn-remove btn btn-sm btn-danger"><i class="fa fa-trash"></i></button></td>\
                </tr>';
